  ...
  Widget _buildContenidoPrincipal() {
    return LayoutBuilder(
      builder: (context, constraints) {
        // Desktop: ancho >= 900 -> mostrar sidebar + contenido en row
        ...
        // Móvil: mantener layout actual (column con categorías horizontales)
  ...
  Widget _buildSidebar() {
    ...
    return Column(
      ...
      children: [
        ...
        // Lista vertical de categorías con placeholder circular
        ..._categorias.map((cat) {
          final icon = _iconos[cat] ?? Icons.label_outlined;
          return ListTile(
